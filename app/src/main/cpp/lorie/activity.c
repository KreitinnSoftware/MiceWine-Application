...
Java_com_micewine_emu_LorieView_connect(__unused JNIEnv* env, __unused jobject cls, jint fd) {
    if (!Charset.self) {
...
JNIEXPORT void JNICALL
Java_com_micewine_emu_LorieView_startLogcat(JNIEnv *env, __unused jobject cls, jint fd) {
...
JNIEXPORT void JNICALL
Java_com_micewine_emu_LorieView_setClipboardSyncEnabled(__unused JNIEnv* env, __unused jobject cls, jboolean enable, __unused jboolean ignored) {
    if (conn_fd != -1) {
...
JNIEXPORT void JNICALL
Java_com_micewine_emu_LorieView_sendClipboardAnnounce(JNIEnv *env, __unused jobject thiz) {
    if (conn_fd != -1) {
...
JNIEXPORT void JNICALL
Java_com_micewine_emu_LorieView_sendClipboardEvent(JNIEnv *env, __unused jobject thiz, jbyteArray text) {
    if (conn_fd != -1 && text) {
...
JNIEXPORT void JNICALL
Java_com_micewine_emu_LorieView_sendWindowChange(__unused JNIEnv* env, __unused jobject cls, jint width, jint height, jint framerate) {
    if (conn_fd != -1) {
...
JNIEXPORT void JNICALL
Java_com_micewine_emu_LorieView_sendMouseEvent(__unused JNIEnv* env, __unused jobject cls, jfloat x, jfloat y, jint which_button, jboolean button_down, jboolean relative) {
    if (conn_fd != -1) {
...
JNIEXPORT void JNICALL
Java_com_micewine_emu_LorieView_sendTouchEvent(__unused JNIEnv* env, __unused jobject cls, jint action, jint id, jint x, jint y) {
...
JNIEXPORT void JNICALL
Java_com_micewine_emu_LorieView_sendStylusEvent(JNIEnv *env, __unused jobject thiz, jfloat x, jfloat y,
...
JNIEXPORT void JNICALL
Java_com_micewine_emu_LorieView_requestStylusEnabled(JNIEnv *env, __unused jclass clazz, jboolean enabled) {
    if (conn_fd != -1) {
...
Java_com_micewine_emu_LorieView_sendKeyEvent(__unused JNIEnv* env, __unused jobject cls, jint scan_code, jint key_code, jboolean key_down) {
    if (conn_fd != -1) {
...
JNIEXPORT void JNICALL
Java_com_micewine_emu_LorieView_sendTextEvent(JNIEnv *env, __unused jobject thiz, jbyteArray text) {
    if (conn_fd != -1 && text) {
        jsize length = (*env)->GetArrayLength(env, text);
        jbyte *str = (*env)->GetByteArrayElements(env, text, NULL);
        char *p = (char*) str;
