...
class Box64SettingsFragment : Fragment() {
    ...
    private fun setAdapter() {
        ...
        addToAdapter(R.string.box64_bigblock, R.string.box64_bigblock_desc, arrayOf("0", "1", "2", "3"), SPINNER, BOX64_DYNAREC_BIGBLOCK_DEFAULT_VALUE, BOX64_DYNAREC_BIGBLOCK)
        addToAdapter(R.string.box64_strongmem, R.string.box64_strongmem_desc, arrayOf("0", "1", "2", "3"), SPINNER, BOX64_DYNAREC_STRONGMEM_DEFAULT_VALUE, BOX64_DYNAREC_STRONGMEM)
        addToAdapter(R.string.box64_weakbarrier, R.string.box64_weakbarrier_desc, arrayOf("0", "1", "2"), SPINNER, BOX64_DYNAREC_WEAKBARRIER_DEFAULT_VALUE, BOX64_DYNAREC_WEAKBARRIER)
        addToAdapter(R.string.box64_pause, R.string.box64_pause_desc, arrayOf("0", "1", "2", "3"), SPINNER, BOX64_DYNAREC_PAUSE_DEFAULT_VALUE, BOX64_DYNAREC_PAUSE)
        addToAdapter(R.string.box64_x87double, R.string.box64_x87double_desc, null, SWITCH, BOX64_DYNAREC_X87DOUBLE_DEFAULT_VALUE, BOX64_DYNAREC_X87DOUBLE)
        addToAdapter(R.string.box64_fastnan, R.string.box64_fastnan_desc, null, SWITCH, BOX64_DYNAREC_FASTNAN_DEFAULT_VALUE, BOX64_DYNAREC_FASTNAN)
        addToAdapter(R.string.box64_fastround, R.string.box64_fastround_desc, null, SWITCH, BOX64_DYNAREC_FASTROUND_DEFAULT_VALUE, BOX64_DYNAREC_FASTROUND)
        addToAdapter(R.string.box64_safeflags, R.string.box64_safeflags_desc, arrayOf("0", "1", "2"), SPINNER, BOX64_DYNAREC_SAFEFLAGS_DEFAULT_VALUE, BOX64_DYNAREC_SAFEFLAGS)
        addToAdapter(R.string.box64_callret, R.string.box64_callret_desc, null, SWITCH, BOX64_DYNAREC_CALLRET_DEFAULT_VALUE, BOX64_DYNAREC_CALLRET)
        addToAdapter(R.string.box64_aligned_atomics, R.string.box64_aligned_atomics_desc, null, SWITCH, BOX64_DYNAREC_ALIGNED_ATOMICS_DEFAULT_VALUE, BOX64_DYNAREC_ALIGNED_ATOMICS)
        addToAdapter(R.string.box64_nativeflags, R.string.box64_nativeflags_desc, null, SWITCH, BOX64_DYNAREC_NATIVEFLAGS_DEFAULT_VALUE, BOX64_DYNAREC_NATIVEFLAGS)
        addToAdapter(R.string.box64_dynarec_wait, R.string.box64_dynarec_wait_desc, null, SWITCH, BOX64_DYNAREC_WAIT_DEFAULT_VALUE, BOX64_DYNAREC_WAIT)
        addToAdapter(R.string.box64_dynarec_dirty, R.string.box64_dynarec_dirty_desc, null, SWITCH, BOX64_DYNAREC_DIRTY_DEFAULT_VALUE, BOX64_DYNAREC_DIRTY)
        addToAdapter(R.string.box64_dynarec_forward, R.string.box64_dynarec_forward_desc, arrayOf("0", "128", "256", "512", "1024"), SPINNER, BOX64_DYNAREC_FORWARD_DEFAULT_VALUE, BOX64_DYNAREC_FORWARD)
        addToAdapter(R.string.box64_avx, R.string.box64_avx_desc, arrayOf("0", "1", "2"), SPINNER, BOX64_AVX_DEFAULT_VALUE, BOX64_AVX)
        addToAdapter(R.string.box64_sse42, R.string.box64_sse42_desc, null, SWITCH, BOX64_SSE42_DEFAULT_VALUE, BOX64_SSE42)
        addToAdapter(R.string.box64_mmap32, R.string.box64_mmap32_desc, null, SWITCH, BOX64_MMAP32_DEFAULT_VALUE, BOX64_MMAP32)
    }
