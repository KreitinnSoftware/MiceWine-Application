...
class Box64SettingsFragment : Fragment() {
    ...
    private fun setAdapter() {
        ...
        addToAdapter(R.string.box64_x87double_title, R.string.box64_x87double_description, arrayOf("0", "1", "2"), SPINNER, BOX64_DYNAREC_X87DOUBLE_DEFAULT_VALUE, BOX64_DYNAREC_X87DOUBLE)
        ...
        addToAdapter(R.string.box64_fastround_title, R.string.box64_fastround_description, arrayOf("0", "1", "2"), SPINNER, BOX64_DYNAREC_FASTROUND_DEFAULT_VALUE, BOX64_DYNAREC_FASTROUND)
        ...
        addToAdapter(R.string.box64_callret_title, R.string.box64_callret_description, arrayOf("0", "1", "2"), SPINNER, BOX64_DYNAREC_CALLRET_DEFAULT_VALUE, BOX64_DYNAREC_CALLRET)
        ...
        addToAdapter(R.string.box64_dynarec_dirty_title, R.string.box64_dynarec_dirty_description, arrayOf("0", "1", "2"), SPINNER, BOX64_DYNAREC_DIRTY_DEFAULT_VALUE, BOX64_DYNAREC_DIRTY)
