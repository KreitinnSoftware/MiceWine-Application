...
public class XKeyCodes {
    ...
    private static final ScanKeyCode[] scanKeyCodes = {
            ...
            new ScanKeyCode("0", 82, 144),
            new ScanKeyCode("1", 79, 145),
            new ScanKeyCode("2", 80, 146),
            new ScanKeyCode("3", 81, 147),
            new ScanKeyCode("4", 75, 148),
            new ScanKeyCode("5", 76, 149),
            new ScanKeyCode("6", 77, 150),
            new ScanKeyCode("7", 71, 151),
            new ScanKeyCode("8", 72, 152),
            new ScanKeyCode("9", 73, 153),
    };
